...
function sim_draws(grd::Dict, params::Dict; T::Integer = 5000, burn = 1000, draw = rand(burn+T, 1),  r = 0.05/52)
   ...
   # Define Grids 
    ...
    return (statet = statet, uxt = uxt, hxyt = hxyt)

end

function sim_draws(grd::Dict, params::Dict, flowsurp::Array; T::Integer = 5000, burn = 1000, draw = rand(burn+T, 1),  r = 0.05/52)
